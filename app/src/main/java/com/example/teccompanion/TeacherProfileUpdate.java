...
public class TeacherProfileUpdate extends AppCompatActivity
{
    ...
    private String fullName, id, batch, regular, session, phone, guardianPhone, address, email, password, image, deptUpdate;
    ...
    private void UpdateProfile()
    {
        ...
        deptUpdate = txtTeacherDept.getText().toString();
        ...
        else if(TextUtils.isEmpty(deptUpdate))
        {
            Toast.makeText(this, "Please enter department", Toast.LENGTH_SHORT).show();
        }

        else if(!deptUpdate.equals("CSE") && !deptUpdate.equals("EEE") && !deptUpdate.equals("Civil") && !deptUpdate.equals("Textile") && !deptUpdate.equals("ICE"))
        {
        ...
        else
        {
                        ...
                        if(task.isSuccessful())
                        {
                            filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri)
                                {
                                    ...
                                    profileMap.put("Dept", deptUpdate);
                                    ...
                                    profileMapTeacher.put("Dept", deptUpdate);
            ...
            if(flag == 0)
            {
                ...
                profileMapTeacher2.put("Dept", deptUpdate);
